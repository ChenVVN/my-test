...
function initRuntimeSocketService() {
  const hosts = "192.168.110.41,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin__keyzf";
...
const b = true, E = "mp-weixin", P = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = E, A = T('{"address":["127.0.0.1","192.168.110.41"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/Users/xl/Downloads/HBuilderX.4.45.2025010502/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"chip-database","spaceId":"mp-df4c0dc9-255d-4a57-8e78-b6b5c9d49725","clientSecret":"jNEvpv4FO5KCREcKbiMQPQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__C830E43";
} catch (e2) {
